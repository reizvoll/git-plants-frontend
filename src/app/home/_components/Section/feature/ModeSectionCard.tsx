      ...
      <div className="flex w-full flex-col gap-10">
        <div className="flex w-full flex-row items-center justify-center gap-10">
          ...
          <div className="flex flex-col items-center">
            <div className="text-center font-galmuri text-body2 text-text-04">🌿 미니 모드</div>
            <br />
            <div className="text-center font-galmuri text-caption text-text-04">
        ...
        <div className="flex w-full flex-row items-center justify-center gap-10">
          <div className="flex flex-col">
            <div className="text-center font-galmuri text-body2 text-text-04">🏅 정원 모드</div>
            <br />
            <div className="text-center font-galmuri text-caption text-text-04">
