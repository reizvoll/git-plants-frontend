  ...
  return (
    <>
      <article
        ...
        className="mx-auto flex w-full max-w-[800px] flex-col items-center justify-center gap-4 rounded-xl bg-secondary-light px-3 py-5 xs:gap-5 xs:px-4 xs:py-6 sm:gap-6 sm:px-5 sm:py-7"
      >
        <section className="flex flex-col items-center justify-center gap-2 xs:gap-3 sm:gap-4" aria-labelledby="system-left-title">
          <h3 id="system-left-title" className="whitespace-pre-line text-center text-[10px] text-text-04 xs:text-[11px] sm:text-caption">
            {t("title-left")}
          </h3>
        ...
        <section className="flex flex-col items-center justify-center gap-2 xs:gap-3 sm:gap-4" aria-labelledby="system-right-title">
          <h3 id="system-right-title" className="whitespace-pre-line text-center text-[10px] text-text-04 xs:text-[11px] sm:text-caption">
            {t("title-right")}
          </h3>
